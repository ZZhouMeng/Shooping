  ...
  var loadMyCartEvent = function(userOptions){
    ...
    if(!$("#" + idCartModal).length) {
      $('body').append(
        ...
        '<button type="button" class="btn btn-default" onclick="createOrdering()" id="button-ordering">生成订单</button>' +
    ...
    var drawTable = function(){
      ...
      $cartTable.append(products.length ?
        ...
        '<td></td>' +
        '</tr>'
        : '<div class="alert alert-danger" role="alert" id="' + idEmptyCartMessage + '">(^・ω・^ )你的购物车空了(°∀°)ﾉ赶快去挑选你喜爱的商品吧！</div>'
      );
